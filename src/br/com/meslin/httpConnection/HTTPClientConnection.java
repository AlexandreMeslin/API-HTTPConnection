 ...
 */
package br.com.meslin.httpConnection;
...
public class HTTPClientConnection {
	 ...
	 */
	public HTTPClientConnection(String endPointIPAddress, int endPointPortNumber) {
		endPointURI = "http://" + endPointIPAddress + ":"+ endPointPortNumber;
	}
	
	/**
	 * Send HTTP DELETE request<br>
	 * Does nothing if endpoint address is 0.0.0.0<br>
